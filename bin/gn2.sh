...
# grep -RHEvi ${KEYWORDS} * | grep -Ev "LCTT翻译规范.md|.git|README" | \
# grep -RHEvi ${KEYWORDS} * | grep -Ev "$(find . -type d | sed 's#[^/]*/##' | \
# awk -F '[/]' '{print $2}')|LCTT翻译规范.md|.git|README" | \
...
echo -e "请前往\033[37;36;7mhttps://github.com/LCTT/TranslateProject/pull/new/master\033[39;49;0m进行"New pull request"操作"
